...
public class FormulaeImpl extends MinimalEObjectImpl.Container implements Formulae
{
  ...
  /**
   * The cached value of the '{@link #getBinop() <em>Binop</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getBinop()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getUnop() <em>Unop</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getUnop()
   * @generated
  ...
  public EList<Binop> getBinop()
  {
    if (binop == null)
    {
      binop = new EObjectContainmentEList<Binop>(Binop.class, this, SattlPackage.FORMULAE__BINOP);
    }
    return binop;
  }
   ...
   */
  @Override
  public EList<Unop> getUnop()
  {
    if (unop == null)
    {
      unop = new EObjectContainmentEList<Unop>(Unop.class, this, SattlPackage.FORMULAE__UNOP);
    }
    return unop;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case SattlPackage.FORMULAE__UNOP:
        return ((InternalEList<?>)getUnop()).basicRemove(otherEnd, msgs);
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case SattlPackage.FORMULAE__UNOP:
        getUnop().clear();
        getUnop().addAll((Collection<? extends Unop>)newValue);
        return;
      case SattlPackage.FORMULAE__FORM:
        getForm().clear();
