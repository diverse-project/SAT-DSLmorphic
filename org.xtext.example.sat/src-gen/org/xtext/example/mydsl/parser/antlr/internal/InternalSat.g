...
entryRuleSolver returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSolverRule()); }
	iv_ruleSolver=ruleSolver
	{ $current=$iv_ruleSolver.current; }
	EOF;

// Rule Solver
ruleSolver returns [EObject current=null]
@init {
	enterRule();
}
@after {
