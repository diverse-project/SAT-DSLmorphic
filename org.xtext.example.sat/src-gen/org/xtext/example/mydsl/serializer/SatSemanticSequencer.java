...
public class SatSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == SatPackage.eINSTANCE)
			...
			case SatPackage.EXPRESSION:
				...
				else if (rule == grammarAccess.getFormulaRule()
						|| rule == grammarAccess.getModelRule()
	 ...
	 *
	 * Constraint:
	 *     (str='sat4j-java' | str='sat4j-jar' | str='sat4j-maven')
	 */
	protected void sequence_Solver(ISerializationContext context, Solver semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
