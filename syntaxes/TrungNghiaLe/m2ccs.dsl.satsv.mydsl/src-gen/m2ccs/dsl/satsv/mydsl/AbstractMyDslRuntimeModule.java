...
import m2ccs.dsl.satsv.mydsl.generator.MyDslGenerator;
import m2ccs.dsl.satsv.mydsl.parser.antlr.MyDslAntlrTokenFileProvider;
import m2ccs.dsl.satsv.mydsl.parser.antlr.MyDslParser;
import m2ccs.dsl.satsv.mydsl.parser.antlr.internal.InternalMyDslLexer;
import m2ccs.dsl.satsv.mydsl.scoping.MyDslScopeProvider;
import m2ccs.dsl.satsv.mydsl.serializer.MyDslSemanticSequencer;
import m2ccs.dsl.satsv.mydsl.serializer.MyDslSyntacticSequencer;
import m2ccs.dsl.satsv.mydsl.services.MyDslGrammarAccess;
import m2ccs.dsl.satsv.mydsl.validation.MyDslConfigurableIssueCodesProvider;
import m2ccs.dsl.satsv.mydsl.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "m2ccs/dsl/satsv/mydsl/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("m2ccs.dsl.satsv.mydsl.MyDsl");
	}
