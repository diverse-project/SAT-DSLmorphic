 ...
 * introduced subclass. 
 */
public class SatdslActivator extends AbstractUIPlugin {

	public static final String PLUGIN_ID = "org.xtext.satdsl.ui";
	public static final String ORG_XTEXT_EXAMPLE_MYDSL_MYDSL = "org.xtext.example.mydsl.MyDsl";
	
	private static final Logger logger = Logger.getLogger(SatdslActivator.class);
	
	private static SatdslActivator INSTANCE;
	...
	public static SatdslActivator getInstance() {
		return INSTANCE;
	}
