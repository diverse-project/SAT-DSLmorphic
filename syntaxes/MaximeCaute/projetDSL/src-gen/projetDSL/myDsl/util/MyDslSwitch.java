...
public class MyDslSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        BooleanExpressionsSystem booleanExpressionsSystem = (BooleanExpressionsSystem)theEObject;
        T result = caseBooleanExpressionsSystem(booleanExpressionsSystem);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Boolean Expressions System</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Boolean Expressions System</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseBooleanExpressionsSystem(BooleanExpressionsSystem object)
  {
    return null;
  }
